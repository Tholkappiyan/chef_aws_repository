...
Vagrant.configure("2") do |config|
  ...
  config.vm.host_name = "tholkappiyan-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tholka_freshdesk"
  #   chef.validation_client_name = "tholka_freshdesk-validator"
  #   chef.validation_key_path = ".chef/tholka_freshdesk-validator.pem"
  # end
end
